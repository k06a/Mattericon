...
#import <UXKit/NSFilePresenter-Protocol.h>
#import <UXKit/NSGestureRecognizerDelegate-Protocol.h>
#import <UXKit/UXCollectionViewLayoutProxyDelegate-Protocol.h>

@class NSArray, NSEvent, NSGestureRecognizer, NSOperationQueue, NSString, NSURL, UXCollectionView, UXCollectionViewLayout, _UXCollectionViewLayoutProxy;
@protocol UXCollectionViewDataSource_Rearranging, UXCollectionViewDelegate_Rearranging;

@interface _UXCollectionViewRearrangingCoordinator : NSObject <UXCollectionViewLayoutProxyDelegate, NSGestureRecognizerDelegate, NSFilePresenter, NSDraggingSource, NSDraggingDestination>
{
    struct {
